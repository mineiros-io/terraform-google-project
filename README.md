...
A [Terraform](https://www.terraform.io) module to create a [Google Project](https://cloud.google.com/resource-manager/docs/creating-managing-projects) on [Google Cloud Services (GCP)](https://cloud.google.com/).
